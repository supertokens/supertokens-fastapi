...
dev-install:
	pip3 install nest-asyncio httpx==0.15.5 pycryptodome pytest jsonschema requests autopep8 flake8 PyYAML pydantic fastapi starlette pytest-asyncio PyJWT uvicorn respx